...
- **M$_{xx}$:**  Normal component in the x-direction (extension or compression along x)
- **M$_{yy}$:**  Normal component in the y-direction (extension or compression along y)
- **M$_{zz}$:**  Normal component in the z-direction (vertical extension or compression)
- **M$_{xy}$:**  Shear component acting in the x-direction on planes normal to y
- **M$_{xz}$:**  Shear component acting in the x-direction on planes normal to z
- **M$_{yz}$:**  Shear component acting in the y-direction on planes normal to z
