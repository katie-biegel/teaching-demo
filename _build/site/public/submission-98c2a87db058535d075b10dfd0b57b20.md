...
Your catalog can be submitted as a comma separated variable file with a single header line.  The header fields must be one of the following fields defined below.
...
## Step 2: Prepare a page describing your catalog
