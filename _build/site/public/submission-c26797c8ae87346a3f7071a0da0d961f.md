...
Each earthquake catalog included in the CRESCENT Earthquake Catalog Repository has a corresponding page in the JupyterBook describing CRESCENT Earthquake Catalog Repository (e.g. the page describing the LFE catalog of Shelly et al. (2025) can be found <a href="https://cascadiaquakes.github.io/earthquake_catalog_repository/shelly-grl-2025/" target="_blank">here</a>).  
