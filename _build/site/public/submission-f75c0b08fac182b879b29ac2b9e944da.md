...
Your catalog can be submitted as a comma separated variable (CSV) file with a single header row.  The header fields must be one of the following fields defined below.
